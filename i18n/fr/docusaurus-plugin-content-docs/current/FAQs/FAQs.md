...
BLOK Capital rewards loyal users with BLOKC, which has a lot of perks along with governance powers.
...
There is no minimum deposit requirement while using BLOK Capital. Users can deposit as little as 10 USDC to their gardens.
